...
_SYSTEM_PROMPTS: dict[AnswerTone, str] = {
    AnswerTone.REGULATORY: (
        ...
        "so explicitly.  Always format your answer with these sections, in "
        "this order, using the exact headers and a blank line between them:\n\n"
        "Executive Summary: <one paragraph>\n"
        "Detailed Explanation: <multi-paragraph grounded analysis>\n"
        "Supporting Evidence: <comma-separated list of chunk ids that back "
        "each claim, e.g. [chunk-id-1, chunk-id-2]>\n"
        "Key Regulatory References: <comma-separated list of acts, "
