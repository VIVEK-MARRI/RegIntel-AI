...
class HierarchyBuilder:
    ...
    def build_hierarchy(
        ...
        """
        logger.info(f"Building hierarchy for document {document_id} from {len(elements)} elements")
        ...
        for el in elements:
            ...
            path_components = [p.numbering or p.title for p in stack[1:]] + [el.numbering or el.title]
