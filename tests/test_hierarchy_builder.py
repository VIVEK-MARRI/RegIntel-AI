...
def test_hierarchy_builder_and_stable_ids():
    ...
    elements = [
        ...
        StructureElement(
            type="chapter", title="Chapter I", numbering="CHAPTER I", page=1, level=1
        ),
        StructureElement(
            type="section", title="Background", numbering="1", page=1, level=2
        ),
        StructureElement(
            type="subsection", title="Applicability", numbering="1.1", page=2, level=3
        ),
        StructureElement(
            type="clause", title="Small accounts", numbering="(a)", page=2, level=5
        ),
        StructureElement(
            type="chapter", title="Chapter II", numbering="CHAPTER II", page=3, level=1
        ),
    ]
    ...
    elements_new_pages = [
        StructureElement(type="title", title="KYC Circular", page=1, level=0),
        StructureElement(
            type="chapter", title="Chapter I", numbering="CHAPTER I", page=2, level=1
        ),  # changed page
        StructureElement(
            type="section", title="Background", numbering="1", page=2, level=2
        ),
        StructureElement(
            type="subsection", title="Applicability", numbering="1.1", page=3, level=3
        ),
        StructureElement(
            type="clause", title="Small accounts", numbering="(a)", page=4, level=5
        ),
        StructureElement(
            type="chapter", title="Chapter II", numbering="CHAPTER II", page=5, level=1
        ),
    ]
    ...
    assert (
        root_new.children[0].children[0].children[0].children[0].node_id
        == clause1.node_id
    )
