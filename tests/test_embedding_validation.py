...
async def test_embedding_validation_rules(db_session):
    ...
    chunks_data = [
        {"content": "Passage 1", "section": "Sec 1", "subsection": "", "page_number": 1, "token_count": 10},
        {"content": "Passage 2", "section": "Sec 1", "subsection": "", "page_number": 1, "token_count": 10},
        {"content": "Passage 3", "section": "Sec 1", "subsection": "", "page_number": 1, "token_count": 10},
        {"content": "Passage 4", "section": "Sec 1", "subsection": "", "page_number": 1, "token_count": 10},
        {"content": "Passage 5", "section": "Sec 1", "subsection": "", "page_number": 1, "token_count": 10}
    ]
    ...
    async def mock_execute(stmt, *args, **kwargs):
        ...
        if "document_chunks" in stmt_str and "chunk_embeddings" in stmt_str and "null" in stmt_str:
            mock_res = MagicMock()
