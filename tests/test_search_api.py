...
async def test_semantic_search_api_flow(client: AsyncClient, db_session):
    ...
    # ----------------------------------------------------
    payload_filter = {"query": "KYC guidelines", "top_k": 5, "source": "RBI"}
    ...
    # ----------------------------------------------------
    payload_page = {"query": "KYC guidelines", "skip": 1, "limit": 1}
    ...
    # ----------------------------------------------------
    payload_invalid = {"query": "KYC guidelines", "distance_metric": "invalid_metric"}
