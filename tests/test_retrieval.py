...
async def test_semantic_retrieval_flow(db_session):
    ...
    # Register chunks
    chunks_rbi = [
        {"content": "RBI kyc section guidelines passage", "section": "Sec 1", "subsection": "", "page_number": 1, "token_count": 10},
        {"content": "RBI Customer diligence passage", "section": "Sec 2", "subsection": "", "page_number": 2, "token_count": 12}
    ]
    chunks_sebi = [
        {"content": "SEBI Mutual fund passage", "section": "Sec 1", "subsection": "", "page_number": 1, "token_count": 10}
    ]
